...
def return_introduction():
    ...
    st.markdown("""
    It turns out that every company has widely different data formats retrieved from their machines/systems.
    The goal of the Data Validation tool is to help you prepare your data for the Data Analytics tool.
    Therefore, at the end, you will hopefully be able to adapt your data in order to make it suitable for later on analysis.
    ...
    st.markdown("""
            Before you start reading the chapters, we advice to install a text editor to examine your data.
             ...
             Another great advantage of Sublime Text is that it open files significantly faster, and it is open source.
             """)
